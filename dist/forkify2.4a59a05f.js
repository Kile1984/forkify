...
const init = function() {
    ...
    (0, _recipeViewJsDefault.default).addHandlerAddBookmark(controlAddBookmar);
...
const loadRecipe = async function(id) {
    try {
        ...
        console.error(`${err} from MODEL \u{1F608}\u{1F608}\u{1F608}\u{1F608}`);
        throw err;
    }
};
...
const getSearchResultsPage = function(page = state.search.page) {
    ...
    const start = (page - 1) * state.search.resultsPerPage; //page=5, 5-1=4 * 10 = 40
    const end = page * state.search.resultsPerPage; // 5 * 10 = 50
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"fd0vu","./View":"jSw21","fracty":"gsPKI"}],"fd0vu":[function(require,module,exports,__globalThis) {
...
},{"url:../../img/icons.svg":"fd0vu","./View":"jSw21","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView":"6tKHS"}],"6tKHS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkupButton(currentpage, type) {
        ...
        <button data-goto="${currentpage + 1}" class="btn--inline pagination__btn--next">
            ...
            `;
        if (type === 'prev') return `
        <button  <button data-goto="${currentpage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
...
class BookmarksView extends (0, _viewDefault.default) {
    ...
    _errorMessage = 'No bookmarks yet. Find a nice ecipe and bookmark it ;)';
    _message = '';
    addHandlerRender(handler) {
...
},{"url:../../img/icons.svg":"fd0vu","./View":"jSw21","./previewView":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8AWnP":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
